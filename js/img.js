$(function () {
    ...
    function feiru() {
        if ((leng - 1) > i) {
            ...
            $('.begin').html('<a href="javascript:void(0);" style="text-decoration: none;color: #fff;background: pink;display: inline-block;padding: 10px;border: 2px solid #fff;" onclick="alert(\'哈哈被骗了吧，没惊喜(狗头保命)\')">点击有惊喜</a>');
            $('.begin').fadeIn();
            return;
        }
    };
